...
<html>
	...
	<body>
		...
		<section>
				...
				if (!mysqli_stmt_prepare($smt, $query)) {
					...
					if ($result->num_rows == 0) {
						...
						while($row = $result->fetch_assoc()) {
							...
							echo '<td><a href="http://clabsql.clamv.jacobs-university.de/~jwhiteley/itemPage.php?r='.$nrow.'">Enlarge</a></td></tr>';
						}
						echo '</table>';
					}
				}
			...
			<a href="http://clabsql.clamv.jacobs-university.de/~jwhiteley/mainPage.php">Back to Main Page</a>
		</section>
	</body>
</html>
