		...
		<section>
			...
			<?php
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					header('Location: http://clabsql.clamv.jacobs-university.de/~jwhiteley/searchResultPage.php');
				}
			?>
		</section>
		<script>
			...
			function toolSelected (toolIndex) {
				...
				window.location.replace("http://clabsql.clamv.jacobs-university.de/~jwhiteley/mainPage.php?active=" + activeTool);
			}
